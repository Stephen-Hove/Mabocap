    ...
    <section className="page-section" id="projects">
      <Container>
        ...
        >
          <b>View all</b>{" "}
          <span>
            <FontAwesomeIcon icon={faArrowRight} /> {/* FontAwesome icon */}
          </span>
        </a>
        ...
        <Modal show={showModal} onHide={() => setShowModal(false)}>
          ...
          <Modal.Body>
            ...
            <h6>
              <b>Start Date: </b> 13 March 2018{/* Add start date here */}
            </h6>
            <h6>
              <b>Completion Date: </b> 18 March 2023{/* Add completion date here */}
            </h6>
            <br />
            <h6>
              <b>Nature of project: </b>
